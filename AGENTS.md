...
A personal content publishing and affiliate-link tool for an outdoor gear site — the owner writes gear posts, the site shows them to visitors, and every click-through to the shop is tracked.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "296507584+jkoh7564@users.noreply.github.com"
  git config user.name "jkoh7564"
  ```
